 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int i = 0; i < N -2; i++){
      ...
      // Smooth the different steering value with with Speed
    ...
    // Initial constraints
    // We add 1 to each of starting indices due to cost being located at
    // index 0 of `fg`
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // The upper and lower limits of detla are set to -25 and 25
  ...
  // Acceleration/decceleration uppper and lower limits
